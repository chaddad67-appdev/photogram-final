class CommentsController < ApplicationController
  ...
  def create
    ...
    if the_comment.valid?
      ...
      redirect_to(request.referer, { :notice => "Comment created successfully." })
    else
      redirect_to(request.referer, { :alert => the_comment.errors.full_messages.to_sentence })
    end
  end
  ...
  def destroy
    ...
    redirect_to(request.referer, { :notice => "Comment deleted successfully."} )
  end
end
